...
export default function GiftBaskets() {
  return (
    <section id="gift-baskets" aria-labelledby="giftbasket-heading" className="relative overflow-hidden pt-2 pb-12 bg-deli-green-dark text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <p className="text-deli-gold-light font-medium tracking-widest uppercase text-sm mb-2">
            The Perfect Gift
          </p>
          <h2 id="giftbasket-heading" className="font-heading text-4xl sm:text-5xl font-bold mb-3">
